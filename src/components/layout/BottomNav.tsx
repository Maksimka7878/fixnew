...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-gray-100/50 shadow-lg" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
